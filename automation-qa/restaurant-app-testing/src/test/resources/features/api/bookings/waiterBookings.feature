Feature: Verify operations on waiter bookings
  ...
  Scenario Outline: Verify successful waiter registration for existing customers
    ...
    Examples:
      | clientType | customerEmail      | date       | guestsNumber | locationId | tableNumber | timeFrom | timeTo |
      | CUSTOMER   | sushma@example.com | 2025-08-22 | 4            | LOC003     | 3           | 15:00    | 16:00  |
  ...
  Scenario Outline: Verify the reservation cannot be made without giving table number
    ...
    Examples:
      ...
      | CUSTOMER   | sushma@example.com | 2025-08-25 | 4            | LOC003     |             | 15:00    | 16:00  | Missing required field: tableNumber                |
      | CUSTOMER   | sushma@example.com | 2025-08-29 | 4            | LOC003     | 999999      | 15:00    | 16:00  | Specified table does not exist.                    |
      | CUSTOMER   | sushma@example.com | 2023-08-29 | 4            | LOC003     | 2           | 15:00    | 16:00  | Reservation cannot be made for a past time.        |
      | CUSTOMER   | sushma@example.com | 2027-08-29 | 4            | LOC003     | 2           | 45:00    | 47:00  | Invalid date/time format. Use yyyy-MM-dd and HH:mm |
  ...
  Scenario Outline: Verify waiter cannot reserve a table at a non-assigned location
    ...
    Examples:
      | clientType | customerEmail      | date       | guestsNumber | locationId | tableNumber | timeFrom | timeTo | message                             |
      | CUSTOMER   | sushma@example.com | 2025-08-25 | 4            | LOC001     | 2           | 15:00    | 16:00  | Missing required field: tableNumber |
