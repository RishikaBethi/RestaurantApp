  ...
  return (
    <div className="bg-gray-100 min-h-screen">
      ...
      <section className="p-10 max-w-6xl mx-auto">
        <h3 className="text-xl font-semibold mb-4">4 tables available</h3>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {tables.map((table) => (
            <div key={table.id} className="bg-white shadow-lg rounded-lg p-4 flex">
              ...
              <div className="ml-4">
                ...
                <button className="mt-2 text-green-600 font-semibold">+ Show all</button>
              </div>
            </div>
          ))}
        </div>
